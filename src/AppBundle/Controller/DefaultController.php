...
class DefaultController extends Controller
{
    ...
    public function playAction(Request $request)
    {
        ...
        // Validate - If provided human gesture id not found
        // redirect with error
        ...
        // Choose random gesture for computer
        // from all gesture options
        $computer_gesture = $gesture_options[ array_rand($gesture_options, 1) ];

        // Run game logic
        $round = $this->get('round_service')->play($human_gesture, $computer_gesture);
