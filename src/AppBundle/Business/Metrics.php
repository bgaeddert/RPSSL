    ...
    public function get(Connection $connection){
        ...
        $raw = $connection->prepare( "
                  SELECT
                      ...
                      sum(CASE WHEN human_gesture_id = '4' THEN 1 ELSE 0 END) human_lizard_count,
                      sum(CASE WHEN human_gesture_id = '5' THEN 1 ELSE 0 END) human_spock_count,
                      ...
                      sum(CASE WHEN comp_gesture_id = '4' THEN 1 ELSE 0 END) comp_lizard_count,
                      sum(CASE WHEN comp_gesture_id = '5' THEN 1 ELSE 0 END) comp_spock_count
                FROM round_log;
        " );
